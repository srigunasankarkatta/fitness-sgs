                        ...
                        <form action="{{ url('admin/blog-post/' . $post->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="slug"  class="form-control slugify"
                                        id="" value="{{ $post->slug }}">
                                    @error('slug')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-12">
                                    <textarea name="blog_description" id="editor">{{ $post->description }}</textarea>
                                </div>
                                @error('description')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-12">
                                    <textarea name="meta_description" id="" class="form-control">{{ $post->meta_description }}</textarea>
                                </div>
