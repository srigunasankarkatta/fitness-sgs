                        ...
                        <form action="{{ url('admin/fitness-center') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active p-3 border" id="basic-details" role="tabpanel"
                                    ...
                                    <div class="form-group row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="name" class="form-control" value="{{$fitness_center->name}}" id="">
                                            @error('name')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="bussiness_name" value="{{$fitness_center->bussiness_name}}" class="form-control" id="">
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="description" id="" class="form-control">{{$fitness_center->description}}</textarea>
                                        </div>
                                        @error('description')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <select name="city" id="" class="form-select">
                                                ...
                                                @foreach ($cities as $city)
                                                    <option value="{{ $city->id }}" {{$fitness_center->city_id == $city->id ? 'selected' : '' ; }} >{{ $city->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('city')
                                                <small class="text-danger">{{ $message }}</small>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="radio" name="status" id="" {{$fitness_center->status == 0 ? 'checked' : '';}}>
                                            @error('status')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="directions" class="form-control" id="" value="{{$fitness_center->directions}}">
                                            @error('name')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="location" class="form-control" id="" value="{{$fitness_center->location}}">
                                            @error('location')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row mb-3">
                                        <div class="col-md-6">
                                            @php
                                             $availability = explode(',', $fitness_center->availability)  ;
                                             
                                            @endphp
                                            <label class="">Availability</label>
                                            <div class="form-check">
                                                <input class="form-check-input" value="morning" @if(in_array("morning", $availability)) checked @endif name="availability[]" type="checkbox" value=""
                                                    id="flexCheckDefault">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" value="evening" @if(in_array("morning", $availability)) checked @endif type="checkbox" name="availability[]" value=""
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" value="0" {{$fitness_center->live_streams == 0 ? 'checked' : '';}}  name="live_streams"
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" value="1" name="live_streams"  {{$fitness_center->live_streams == 0 ? 'checked' : '';}}
                                    ...
                                    <div class="form-group row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="duration" class="form-control" id="" value="{{$fitness_center->duration}}">
                                            @error('duration')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="kcal" class="form-control" id="" value="{{$fitness_center->kcal}}">
                                            @error('kcal')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="tab-pane fade p-3 border" id="media-library" role="tabpanel"
                                    ...
                                    <div class="form-group row mb-3">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                @forelse ($fitness_center->fitnessCenterSliderImages as $fitness_center_image)
                                                    <div class="col-md-4">
                                                        <div class="card mb-3">
                                                            <img style="object-fit: cover;padding: 1px;border-radius:6px;"
                                                                src="{{ url('') }}/{{ $fitness_center_image->image }}"
                                                                height="200px" alt="">
                                                            <div class="card-footer">
                                                                <a href="{{ url('admin/expert-image/' . $fitness_center_image->id . '/delete') }}"
                                                                    class="btn btn-secondary">remove</a>
                                                                <a href="{{ url('admin/expert-image/' . $fitness_center_image->id . '/update') }}"
                                    ...
                                    <div class="row">
                                        @forelse ($fitness_center->fitnessCenterBannerVideos as $fitness_center_ideo)
                                            <div class="col-md-4">
                                                <div class="card mb-3">
                                                    <video height="100%" style="padding: 1px;" controls>
                                                        <source
                                                            src="{{ url('') }}/{{ $fitness_center_ideo->video }}"
                                                            type="video/mp4">
                                                        <source
                                                            src="{{ url('') }}/{{ $fitness_center_ideo->video }}"
                                                            type="video/ogg">
                                                    ...
                                                    <div class="card-footer">
                                                        <a href="{{ url('admin/expert-video/' . $fitness_center_ideo->id . '/delete') }}"
                                                            class="btn btn-secondary">remove</a>
                                                        <a href="{{ url('admin/expert-video/' . $fitness_center_ideo->id . '/update') }}"
                                                            class="btn btn-secondary">update</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade p-3 border" id="amenities" role="tabpanel"
                                    ...
                                    @forelse ($fitness_center->fitnessCenterAmenities as $fitness_center_amenity)
                                    <div class="col-md-12 col-md-5">
                                        <div class="form-group row">
                                                
                                            <div class="col-md-5">
                                                <input class="form-control " value="{{$fitness_center_amenity->icon}}" name="amenity_icon[]" type="text">
                                            </div>
                                            <div class="col-md-5">
                                                <input class="form-control " value="{{$fitness_center_amenity->name}}" name="amenity_name[]" type="text">
                                            </div>
                                            <div class="col-md-2 ">
                                ...
                                <div class="tab-pane fade p-3 border" id="services" role="tabpanel"
                                    ...
                                    <div data-spy="scroll" class="form-group row mb-3 crollspy-example-2">
                                        @forelse ($fitness_center->fitnessCenterServices as $fitness_center_amenity)
                                        <div class="col-md-12 col-md-5">
                                            <div class="form-group row">
